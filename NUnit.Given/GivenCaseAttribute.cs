...
{
    public class GivenCaseAttribute : TestCaseAttribute, ITestBuilder
    {
        private static readonly NUnitTestCaseBuilder Builder = new NUnitTestCaseBuilder();

        public GivenCaseAttribute(Type contextType, object arg) : base(arg)
        {
            SetContextType(contextType);
        }

        public GivenCaseAttribute(Type contextType, params object[] arguments) : base(arguments)
        {
            SetContextType(contextType);
        }

        public GivenCaseAttribute(Type contextType, object arg1, object arg2) : base(arg1, arg2)
        {
            SetContextType(contextType);
        }

        public GivenCaseAttribute(Type contextType, object arg1, object arg2, object arg3) : base(arg1, arg2, arg3)
        {
            SetContextType(contextType);
        }
